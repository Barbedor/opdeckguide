...
export const op17EastSep11DeckTemplates = {
	...
	"robin-op17-east-bookoff-sep11-higeurara": [leader("OP09-062"), card("OP17-113", 4), card("OP17-107", 4), card("OP17-109", 4), card("OP17-102", 4), card("EB04-058", 2), card("OP17-106", 4), card("ST36-005", 2), card("OP17-114", 4), card("OP17-110", 2), card("OP16-119", 4), card("OP17-112", 4), card("ST34-003", 4), card("OP17-074", 4), card("OP09-078", 4, "Event")],
	"rocks-op17-east-ck-mizonokuchi-sep11-saho": [leader("OP17-039"), card("OP08-051", 4), card("OP17-045", 4), card("OP17-054", 4), card("OP17-041", 3), card("OP17-042", 4), card("OP17-044", 3), card("OP17-046", 4), card("OP17-049", 4), card("OP17-040", 4), card("OP17-048", 4), card("OP17-118", 4), card("OP17-055", 4, "Event"), card("OP17-056", 4, "Event")],
};
...
export const op17EastSep11EntrySeeds = [
	...
	entry("robin-op17-east-bookoff-sep11-higeurara", "nico-robin-op09", "Nico Robin OP17 Flagship Battle Winner", "FS", "Flagship Battle", "1st Place", "Higeurara", "Bookoff"),
	entry("rocks-op17-east-ck-mizonokuchi-sep11-saho", "rocks-d-xebec-op17", "Rocks D Xebec OP17 Standard Battle Winner", "SB", "Standard Battle", "1st Place", "Saho", "CK_mizonokuchi"),
];

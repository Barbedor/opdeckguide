export const deckGuides = [
	...
	{
		kind: "deck",
		title: "Portgas.D.Ace OP16 Preview Deck Guide",
		leader: "Portgas.D.Ace",
		code: "OP16",
		formatLabel: "OP16 Format",
		summary: "Preview guide with an early decklist idea, key Ace spoilers, the old-set shell, and early strengths and weaknesses.",
		month: "May",
		...
		tags: ["op16", "red", "whitebeard pirates", "preview"],
	},
	{
		kind: "deck",
		title: "Buggy OP16 Preview Deck Guide",
		leader: "Buggy",
		code: "OP16",
		formatLabel: "OP16 Format",
		summary: "Preview guide with an early decklist idea, the Impel Down package, the old-set shell, and early strengths and weaknesses.",
		month: "May",
		...
		tags: ["op16", "blue", "impel down", "buggy pirates", "preview"],
	},
	{
		kind: "deck",
	...
	{
		kind: "deck",
		title: "Marshall.D.Teach OP16 Preview Deck Guide",
		leader: "Marshall.D.Teach",
		code: "OP16",
		formatLabel: "OP16 Format",
		summary: "Preview guide with an early decklist idea, key Blackbeard spoilers, the old-set shell, and early strengths and weaknesses.",
		month: "May",
		...
		tags: ["op16", "black", "yellow", "blackbeard pirates", "preview"],
	},
	{
		kind: "deck",

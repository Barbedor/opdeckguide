export const deckGuides = [
	...
	{
		kind: "deck",
		title: "Sengoku OP16 Preview Deck Guide",
		leader: "Sengoku",
		code: "OP16",
		formatLabel: "OP16 Format",
		summary: "Preview guide with an early decklist idea, the Navy package, the old-set shell, and early strengths and weaknesses.",
		month: "May",
		...
		tags: ["op16", "purple", "navy", "admiral", "preview"],
	},
	{
		kind: "deck",
